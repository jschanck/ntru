...
if __name__ == '__main__':
    ...
    if args.shufbytes:
        ...
        if args.raw_name:
            f.__name__ = "{}square_{}_821".format(args.namespace, args.no_of_squarings)
        else:
            f.__name__ = "{}square_{}_821_shufbytes".format(args.namespace, args.no_of_squarings)
        ...
        if args.raw_name:
            ...
            f.__name__ = "{}square_{}_821_patience".format(args.namespace, args.no_of_squarings)
