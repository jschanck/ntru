...
#define NTRU_PACK_TRINARY_BYTES    ((NTRU_N+4)/5)

#define NTRU_OWCPA_MSGBYTES       (NTRU_PACK_TRINARY_BYTES)
#define NTRU_OWCPA_PUBLICKEYBYTES ((NTRU_LOGQ*NTRU_N+7)/8)
#define NTRU_OWCPA_SECRETKEYBYTES (2*NTRU_PACK_TRINARY_BYTES)
#define NTRU_OWCPA_BYTES          ((NTRU_LOGQ*NTRU_N+7)/8)
...
#define NTRU_BYTES          (NTRU_OWCPA_BYTES+NTRU_OWCPA_MSGBYTES)
